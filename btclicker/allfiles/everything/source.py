...
if data == "None":
    Npos = float(input("Please enter the X of the number coordinates (pixels): ")), float(input("Please enter the Y of the number coordinates (pixels): "))#(325, 310)
    Apos = float(input("Please enter the X of the A coordinates (pixels): ")), float(input("Please enter the Y of the A coordinates (pixels): "))#(670, 710)
    Bpos = float(input("Please enter the X of the B coordinates (pixels): ")), float(input("Please enter the Y of the B coordinates (pixels): "))#(1270, 910)
    Epos = float(input("Please enter the X of the extra coordinates: ")), float(input("Please enter the Y of the extra coordinates: "))#(1200, 510)
